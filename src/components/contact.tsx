    ...
    return (
        <div ref={contactRef} className="flex h-screen text-white bg-primary">
            <div className="flex flex-col items-center justify-center w-full h-full gap-x-12 xl:items-end px-9">
                <form className="flex flex-col gap-6 items-center justify-center w-[500px] bg-[#100d25] p-5 rounded-xl">
                ...
                <div className="flex h-6 w-[500px] text-gray-600 justify-center items-center pt-8 gap-5 text-3xl">
